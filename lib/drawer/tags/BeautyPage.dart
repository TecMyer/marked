...
class BeautyPage extends StatefulWidget {
  ...
  @override
  _BeautyPageState createState() => new _BeautyPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Beauty",style: TextStyle(color: Colors.white),),
        centerTitle: true,
        elevation: 0,
              ...
              children: [
                ...
                Expanded(
                    child: Container(
                      ...
                      child:beautyModel ==null || beautyModel.data.length==0?
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Container(
                          ...
                          Container(
                              width: width*0.65,
                              child: Text('To add items to your archive, tap the checkmark button after opening an item.',
                                style: TextStyle(color: HexToColor(MyConstants.greyClr),fontSize: 13,fontWeight: FontWeight.w500),
                                maxLines: 2,overflow: TextOverflow.ellipsis,textAlign: TextAlign.center,
                              )
                          ),
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return  Padding(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                MyConstants.currentArticleData=beautyModel.data[index];
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                                fit: BoxFit.fill,
                                                image: NetworkImage(beautyModel.data[index].imageUrl)
                                            )
                                        ),
                                      ),
                                      Container(
                                        ...
                                        child:Column(
                                          children: [
                                            Text(beautyModel.data[index].title,style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w500),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                            SizedBox(height: 5,),
                                            Row(
                                              children: [
                                                Image.asset('assets/globe.png',height: height/35,),
                                                SizedBox(width: 5,),
                                                Text(beautyModel.data[index].websiteName,style: TextStyle(color: Colors.black,fontSize: 10),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                              ],
                                            ),
                                            SizedBox(height: 5,),
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 5,),
                                                Text(MyConstants.getDifference(currDate, beautyModel.data[index].creationDate),style: TextStyle(color: Colors.black,fontSize: 10),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                              ],
                                            ),
                                          ],
                                        ),
