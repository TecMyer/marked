...
class ArchivePage extends StatefulWidget {
  ...
  @override
  _ArchivePageState createState() => new _ArchivePageState();
}
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Image.asset('assets/archive.png',width: width*0.07,color: Colors.white,fit: BoxFit.fill,),
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: archiveModel == null || archiveModel.data.length==0?
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Container(
                        width: width*0.65,
                        child: Text('There are no archives in your list.',
                ...
                :
            GridView.builder(
              itemCount: archiveModel.data.length,
              ...
              itemBuilder: (BuildContext context, int index) {
                return  Padding(
                  ...
                  child: GestureDetector(
                    onTap: (){
                      MyConstants.currentArticleData=archiveModel.data[index];
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(archiveModel.data[index].imageUrl)
                                  )
                              ),
                            ),
                            Container(
                              ...
                              child:Column(
                                children: [
                                  Text(archiveModel.data[index].title,style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w500),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                  SizedBox(height: 5,),
                                  Row(
                                    children: [
                                      Image.asset('assets/globe.png',height: height/35,),
                                      SizedBox(width: 5,),
                                      Text(archiveModel.data[index].websiteName,style: TextStyle(color: Colors.black,fontSize: 10),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                    ],
                                  ),
                                  SizedBox(height: 5,),
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 5,),
                                      Text(MyConstants.getDifference(currDate, archiveModel.data[index].creationDate),style: TextStyle(color: Colors.black,fontSize: 10),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                    ],
                                  ),
                                ],
                              ),
