...
class _TrendingPageState extends State<TrendingPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Image.asset('assets/trending.png',width: width*0.07,color: Colors.white,fit: BoxFit.fill,),
                    ...
                    child: Container(
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                              width: width*0.65,
                              child: Text('There are no trendings.',
  ...
  void getTrendingList() async{
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      ApiCall.getTrendList().then((value) async {
        MyConstants.hideLoadingBar();
        if (value.statusCode==200) {
          if(json.decode(value.body)["success"]=="true"){
            trendModel = ArticleModel.fromJson(json.decode(value.body));
            dummyModel=trendModel;
            setState(() {
