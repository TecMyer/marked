...
class _ArticlePageState extends State<ArticlePage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Image.asset('assets/article.png',width: width*0.07,color: Colors.white,fit: BoxFit.fill,),
            SizedBox(width: width*0.03,),
            Text("Articles",style: TextStyle(color: Colors.white),),
          ],
        ),
        centerTitle: true,
        elevation: 0,
                    ...
                    child: Container(
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                              width: width*0.65,
                              child: Text('There are no Articles in your list.',
  ...
  void getArticles() async{
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      ApiCall.getArticles().then((value) async {
