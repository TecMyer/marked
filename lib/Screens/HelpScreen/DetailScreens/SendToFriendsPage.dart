...
class SendToFriendsPage extends StatefulWidget {

  @override
  _SendToFriendsPageState createState() => new _SendToFriendsPageState();
}

class _SendToFriendsPageState extends State<SendToFriendsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:Text("Send To Friends", style: TextStyle(color: Colors.white),),
